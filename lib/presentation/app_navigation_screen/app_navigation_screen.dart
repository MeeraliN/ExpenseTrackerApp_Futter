...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  onTapHomepagewithoutKYC() {
    Get.toNamed(AppRoutes.homePageWithoutKycScreen);
  }

  onTapAddingtransaction() {
    Get.toNamed(AppRoutes.addingTransactionScreen);
  }
